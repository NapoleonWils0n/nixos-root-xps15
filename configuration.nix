...
${pkgs.util-linux}/bin:$PATH"
  ...
  dwlWithDwlbWrapper = pkgs.writeScriptBin "dwl-with-dwlb" ''
      #!/bin/sh
      # Launch dwlb directly, using its -status option to provide custom text.
      # dwlb itself will handle displaying tags, layout, and title.
      # The font and status command strings are correctly escaped for the shell.
